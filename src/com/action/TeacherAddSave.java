...
//		System.out.println(Teacher_Sex);
	...
	public String execute() throws Exception {
		...
		if(list.size()>0)
		{
			out.print("<script language='javascript'>alert('用户名已经存在,请重选！');history.back(-1);</script>");
			out.flush();out.close();return null;
		}
		//添加
...
//		System.out.println(Teacher_Name);
		...
		//跳转
		out.print("<script language='javascript'>alert('添加成过！');window.location='TeacherManager.action';</script>");
		out.flush();out.close();return null;
