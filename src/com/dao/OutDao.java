...
public class OutDao {
	...
	public List<OutBean> GetList(String strwhere,String strorder){
		String sql="select *  from  building a,domitory b,Out1 o,Student s where o.Out_StudentID=s.Student_ID and a.Building_ID = b.Domitory_BuildingID and a.Building_ID !=0 and Student_DomitoryID = Domitory_ID";
		//select Out_ID,Out_StudentID,Student_Username,Student_Name,Student_Sex,Student_Class,Building_Name,Domitory_Name,Out_Date,Out_Remark  from  building a,domitory b,Out1 o,Student s where o.Out_StudentID=s.Student_ID and a.Building_ID = b.Domitory_BuildingID and a.Building_ID !=0 and Student_DomitoryID = Domitory_ID
