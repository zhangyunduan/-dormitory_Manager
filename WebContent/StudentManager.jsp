...
<div class="wrapper  fadeInRight" style="padding: 5 10px; "  >
    <a href="StudentAdd.jsp" class="btn btn-primary"
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <select class="select1" name="SearchRow" id="SearchRow">
                            <option value="Student_Name" selected="selected">姓名</option>
                            <option value="Student_Username">学号</option>
                            <option value="Student_Class">班级</option>
                        </select>
                        <!--<span class="year">名称：</span>-->
                        <input autocomplete="off"  type="text" class="" name="SearchKey" id="SearchKey" style="height: 25px;margin-left: 10px;">
                    ...
                    <div class="ibox-content">
                        <table  class=" table table-striped table-bordered table-hover"  >
                         ...
                         <s:iterator id="aa" value="list">
                    		...
                    		<td>${Building_Name}</td>
                    		<td>${Domitory_Name}</td>
                    		<td align="left">${Student_State}</td>
                    		<td align="left"><a href="StudentUpdate.action?Student_ID=${Student_ID}">修改</a> <a href="StudentDel.action?Student_ID=${Student_ID}" onClick="return confirm('确定要删除该学生吗？')">删除</a></td>
                  			</tr>
               			</s:iterator>
                            </thead>
                        </table>
