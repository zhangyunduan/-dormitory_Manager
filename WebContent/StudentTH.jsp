        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form name="form1" method="post" action="StudentTH.action" onSubmit="return mycheck()" class="ng-pristine ng-valid">
                        <div class="form-group">
                            <label for="4">学生学号：</label>
                            <input type="text" class="form-control "  name="Student_Username"
                                   id="Student_Username" placeholder="请输入要调换寝室的学生的学号"  autocomplete="off">
                        </div>
